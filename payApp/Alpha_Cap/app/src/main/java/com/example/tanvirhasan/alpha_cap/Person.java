...
public class Person {   ///for store single data
   ...
   private String _name , _id , _pass , _mob , _email , _method , _toUrl;

    public Person(String _name, String _id, String _pass, String _mob, String _email, String _method, String _toUrl) {
        this._name = _name;
        this._id = _id;
        this._pass = _pass;
        this._mob = _mob;
